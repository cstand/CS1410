...
class TestKaleidoscope(asttest.ASTTest):
    ...
    def test_functions(self):
        ...
        self.assertGreaterEqual(
            len(func_defs), 8, "You should have a minimum " "of 8 functions."
        )
            ...
            for call in calls:
                if isinstance(call.func, ast.Attribute):
                    if call.func.value.id == "turtle" and call.func.attr == "Turtle":
                        ...
                        break
        self.assertGreaterEqual(
            len(turtles), 4, "You should have a minimum of 4 " "turtle objects"
        )
        ...
        self.assertTrue(
            called_range,
            "You should call the range() function "
            "in your main function to loop over your turtle objects",
        )
        self.assertTrue(
            called_randrange,
            "You should call the randrange() "
