...
class TestApplyAction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.recordTripAction = gas_mileage.recordTripAction
        self.listTripsAction = gas_mileage.listTripsAction
        self.calculateMPGAction = gas_mileage.calculateMPGAction
        self.quitAction = gas_mileage.quitAction
    ...
    def tearDown(self):
        gas_mileage.recordTripAction = self.recordTripAction
        gas_mileage.listTripsAction = self.listTripsAction
        gas_mileage.calculateMPGAction = self.calculateMPGAction
        gas_mileage.quitAction = self.quitAction
        return
